...
public class ContainerController {
	...
	// SELECT * FROM SYVSLPP WHERE CDTYLP='LNCD' AND VSCDLP='XFEIZ' AND
	// VYIMLP='JK044N'
	 ...
	 * 调用(CMA下属船公司ANL)
	 * {"vscd":"XFEIZ","vsdr":"I","vsvy":"JK044N","lncd":"CMA","ordertype":
	 * "PORT"} 该功能仅支持 船公司进行查询，必须传入箱主代码
	 */
	@TokenCheck
	...
	/*
	 * 调用 {"vscd":"OOLCA","vsdr":"E","vsvy":"066E","usertype":"H","caag":"CNC",
	 * "ordertype":"PORT"} 调用
	 * {"vscd":"XMZ78","vsdr":"E","vsvy":"813N","usertype":"V","lncd":"OOL",
	 * "ordertype":"PORT"}
	 * {"vscd":"OOLTP","vsdr":"E","vsvy":"035E","usertype":"V","lncd":"CMA",
	 * "ordertype":"PORT"} 该功能支持 船公司/货代进行查询，必须传入用户类型V/H和箱主/货代代码
	 */
	@TokenCheck
